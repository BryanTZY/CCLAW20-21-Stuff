...
#shows input format: python3 file_dir/xxxx.py -- 2016 2020
...
def validate(args: List[str]):
    ...
    if len(args) > 1:
        if end_year>current_year:
            ...
            print("End year cannot be more than start year.")
            raise SystemExit()
    else:
        end_year = start_year
...
def main() -> None:
    ...
    if args[0] == "--help":
        ...
        validate(args)
        scrape_by_years (sys.argv[0], start_year, end_year) #pass into scraper. filename?
